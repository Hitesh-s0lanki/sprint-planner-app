...
export const metadata = generateSEOMetadata({
  title: "For Investors & Venture Studios – SprintPlanner",
  description:
    "Run serious 4-week idea sprints before you commit capital. SprintPlanner gives you an execution-first view of founders with anonymous Q&A and AI-powered summaries built in.",
  path: "/investors",
  image: "/og-investors.png", // Recommended: Create a 1200x630px OG image for investors page
  imageAlt:
    "SprintPlanner for Investors - Run 4-week idea sprints before committing capital",
  keywords: [
    "investor tools",
    "venture studio",
    "founder screening",
...
export default function InvestorsPage() {
  ...
  const breadcrumbs = generateBreadcrumbSchema([
    ...
    { name: "For Investors", url: `${baseUrl}/investors` },
  ]);
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 lg:flex-row lg:items-center lg:justify-between lg:py-20">
            <div className="max-w-xl space-y-5">
              ...
              <p className="text-sm text-slate-600 md:text-base">
                ...
                sprint — with anonymous Q&amp;A and AI-powered summaries built
                in.
              </p>
              ...
              <Card className="rounded-2xl border-slate-200 bg-white shadow-sm">
                <CardContent className="space-y-4 p-6">
                  ...
                  <p className="text-sm font-semibold text-slate-900">
                    One sprint → clear picture of founder quality, idea
                    potential, and execution speed.
                  </p>
                  <div className="space-y-2 text-xs text-slate-600">
                    ...
                    <div className="flex items-start gap-2">
                      <ArrowDownRight className="mt-0.5 h-4 w-4 text-emerald-500" />
                      <span>
                        Use the sprint narrative as input to IC memos and
                        partner discussions.
                      </span>
                    </div>
                  </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-14 lg:px-8 lg:py-18">
            <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-md text-sm text-slate-600 md:text-base">
                ...
                reducing time spent on founders and ideas that aren&apos;t
                ready.
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-[1.1fr_1.1fr]">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-slate-600 md:text-base">
                  ...
                  own words; AI turns the conversation into a compact summary
                  that travels with the sprint.
                </p>
                ...
                <CardContent className="space-y-4 p-6 md:p-7">
                  ...
                  <div className="space-y-3 rounded-xl bg-white p-4 text-xs text-slate-700 shadow-sm">
                    ...
                    <ul className="space-y-1.5">
                      ...
                      <li>
                        • Which metric are you optimising for this sprint?
                      </li>
                      <li>
