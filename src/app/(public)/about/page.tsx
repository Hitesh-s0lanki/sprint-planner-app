...
export const metadata = generateSEOMetadata({
  title: "About Us – SprintPlanner",
  description:
    "Learn about SprintPlanner's mission to simplify agile sprint planning and improve team productivity. Built for builders, small teams, and investors who care about execution.",
  path: "/about",
  image: "/og-about.png", // Recommended: Create a 1200x630px OG image for about page
  imageAlt: "About SprintPlanner - Built for builders and investors",
  keywords: [
    "about SprintPlanner",
    "venture planning",
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-10 px-4 py-16 lg:flex-row lg:items-center lg:justify-between lg:py-20">
            <div className="max-w-xl space-y-5">
              ...
              <p className="text-sm text-slate-600 md:text-base">
                SprintPlanner exists for builders who are tired of “someday”.
                It’s a focused system that helps you give one idea a serious
                4-week shot — with clear structure, fewer distractions, and
                ...
                <CardContent className="space-y-5 p-6">
                  ...
                  <div className="grid gap-3 text-xs text-slate-600">
                    ...
                    <div className="flex items-start gap-2">
                      <CheckCircle2 className="mt-0.5 h-4 w-4 text-emerald-500" />
                      <span>
                        Outputs that naturally translate into investor
                        narratives.
                      </span>
                    </div>
                  </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-14 lg:px-8 lg:py-18">
            <div className="mb-8 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              ...
              <p className="max-w-md text-sm text-slate-600 md:text-base">
                The goal is not to plan forever — it’s to give your idea a
                crisp, well-run 4-week sprint that results in real evidence.
              </p>
            </div>
          ...
          <div className="mx-auto max-w-6xl px-4 py-14 lg:px-8 lg:py-18">
            <div className="mb-8 text-center">
              ...
              <p className="mt-2 text-sm text-slate-600 md:text-base">
                ...
                work, while making it easy to communicate with the people
                backing it.
              </p>
            </div>
            ...
            <p className="mt-8 text-center text-xs text-slate-500 md:text-sm">
              The mission is simple: help more builders move from “I have an
              idea” to “I ran a real sprint and here’s what I learned”.
            </p>
          </div>
        </section>
      </main>
